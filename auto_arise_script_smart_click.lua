-- Auto Arise GUI: Anti-AFK + Auto Desert Infinite con clic inteligente
...
-- Función para simular clic físico en pantalla
...
local function entrarADesert()
    ...
    if desertUI then
        ...
        if createBtn then
            if createBtn.MouseButton1Click then
                pcall(function() createBtn:Activate() end)
                pcall(function() createBtn.MouseButton1Click:Fire() end)
            else
        ...
        for i = 1, 10 do
            ...
            if joinBtn and joinBtn.Visible then
                if joinBtn.MouseButton1Click then
                    pcall(function() joinBtn:Activate() end)
                    pcall(function() joinBtn.MouseButton1Click:Fire() end)
                else
                ...
                while desertActivo do
                    ...
                    if waveGui and waveGui:IsA("TextLabel") then
                        ...
                        if num and num >= rondaObjetivo then
                            ...
                            if leaveBtn then
                                if leaveBtn.MouseButton1Click then
                                    pcall(function() leaveBtn:Activate() end)
                                    pcall(function() leaveBtn.MouseButton1Click:Fire() end)
                                else
                                    simulateClick(leaveBtn)
                                end
                            end
                            break
                        end
